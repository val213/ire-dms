...
package com.example.iredms.config;
...
public class RestTemplateConfig {
     ...
     * 构建 RestTemplate 对象，忽略证书校验。
     *
     * @param builder builder * @return RestTemplate 对象
     */
    @Bean
    public RestTemplate restTemplate(RestTemplateBuilder builder) {
        TrustManager[] trustAllCerts = new TrustManager[] {
                new X509TrustManager() {
                     ...
                     * 校验客户端证书
                     *
                     * @param certs the peer certificate chain* @param authType the authentication type based on the client
                    certificate */
